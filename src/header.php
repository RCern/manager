...
<!-- Links on the right -->
    <a href="connexion_Login.php" class="aBig col s3 hide-on-med-and-down zoom whiteToBlueLight">
    ...
    <a href="connexion_Sign_Up.php" class="aBig col s3 hide-on-med-and-down zoom whiteToBlueLight">
